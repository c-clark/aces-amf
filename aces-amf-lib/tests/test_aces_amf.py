...
def test_amf_housekeeping_updates_with_unfilled_amf():
    """Make sure the rev_up method builds needed AMF structure"""
    less_than_minimal_amf = b"""<?xml version="1.0" encoding="UTF-8"?>
<aces:acesMetadataFile version="2.0" xmlns:aces="urn:ampas:aces:amf:v2.0">
</aces:acesMetadataFile>"""
    amf = ACESAMF.from_data(less_than_minimal_amf)
