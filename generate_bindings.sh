...
SCHEMA="$LIB_SRC/aswf/aces/amf_lib/data/amf-schema/v2/acesMetadataFile.xsd"
PATCHES_DIR="$REPO_ROOT/packages/aces-amf-lib/patches"
OUTDIR="$LIB_SRC/aswf/aces/amf_lib/amf"
PACKAGE="aswf.aces.amf_lib.amf"
...
generate() {
    ...
    if [[ -d "$tmpdir/aswf/aces/amf_lib/amf" ]]; then
        rm -rf "$OUTDIR"
        mv "$tmpdir/aswf/aces/amf_lib/amf" "$OUTDIR"
    else
...
gen_patches() {
    ...
    local raw_dir="$tmpdir/aswf/aces/amf_lib/amf"
