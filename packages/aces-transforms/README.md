...
2. **Replace the bundled data file** at `src/aswf/aces/transforms/data/aces_transforms.json`.

3. **Bump the package version** in `pyproject.toml` and `src/aswf/aces/transforms/__init__.py`.
