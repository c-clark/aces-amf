...
from aces.amf_utils.cli.validate import validate
from aces.amf_utils.cli.info import info
from aces.amf_utils.cli.create import create
from aces.amf_utils.cli.edit import add_cdl, compute_hashes
from aces.amf_utils.cli.diff_cmd import diff
from aces.amf_utils.cli.transforms import transforms
from aces.amf_utils.cli.templates import template
from aces.amf_utils.cli.resolve import resolve_urns
...
@click.option(
    "--registry",
    default="aces.transforms:ACESTransformRegistry",
    show_default=True,
