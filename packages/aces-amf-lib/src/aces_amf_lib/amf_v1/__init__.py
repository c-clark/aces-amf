...
from aces_amf_lib.amf_v1.aces_metadata_file import (
    AcesMetadataFile,
    AuthorType,
    CdlWorkingSpaceType,
    ClipIdType,
...
from aces_amf_lib.amf_v1.st433b_2008_am1_2011 import (
    CurrentModeToken,
    CurrentType,
    CurrentUnitsToken,
    DeviceDescription,
...
from aces_amf_lib.amf_v1.xmldsig_core_schema import (
